...
import com.wengmengfan.sttwang.presenter.contract.ViewBoxContract;
import com.wengmengfan.sttwang.presenter.impl.ViewBoxPresenter;
import com.wengmengfan.sttwang.utils.DeviceUtils;
            ...
            if(jieya) {
                ...
                for (File f : files) {
                    if (f.getAbsolutePath().endsWith(".torrent")) {
                        ...
                        try {
                            long dd = XLTaskHelper.instance().addThunderTask("thunder://QUFodHRwOi8vZGwxMDcuODBzLmNvbS5jbzo5OTkvMTgwMy/ph5Fz5qKm5LmhL+mHkXPmoqbkuaFfYmQubXA0Wlo=", videoPath, null);
                             Logger.e("DD >>  "+dd);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }

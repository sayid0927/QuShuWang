...
import com.wengmengfan.doutu.bean.BookInfoBean;
import com.wengmengfan.doutu.bean.NewestBean;
import com.wengmengfan.doutu.presenter.contract.ChapterContract;
...
public class NewestHomePresenter extends RxPresenter<NewestHomeContract.View> implements NewestHomeContract.Presenter<NewestHomeContract.View> {

    private Api bookApi;
    public static boolean isLastSyncUpdateed = false;

    @Inject
    public NewestHomePresenter(Api bookApi) {
        this.bookApi = bookApi;
    }

    @Override
    public void Fetch_NewestInfo(final String Url ) {
...
//                    Document doc = Jsoup.connect(Url).get();
                    Elements elements = doc.select("div.soresult");
                ...
                .subscribe(new Observer<List<NewestBean>>() {
                    ...
                    public void onNext(List<NewestBean> data) {
                        if (data != null && mView != null) {
                            mView.Fetch_NewestInfo_Success(data);
                        }
                    }
                });
    }
